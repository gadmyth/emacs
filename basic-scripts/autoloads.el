...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "customized-dir" '("*customized-dir*" "+customized-dir-file-name+" "+dired-al-mode-header+" "add-customized-dir" "customized-dir" "load-customized-dir" "remove-customized-dir" "save-customized-dir" "switch-to-customized-dir" "wrap-function-with-default-directory")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dates" '("+date-command+" "current-time" "org-current-timestamp" "quick-on-time" "string-to-timestamp" "system-" "timestamp-to-string-with-format")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "el-server" '("*my-default-elnode-" "elnode-" "my-" "reset-my-default-elnode-url-mapping-table")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "frames" '("*max-frame-" "get-workspace" "goto-workspace-by-number" "set-suitable-frame-size")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "packages" '("+option-packages+" "+required-packages+" "+tool-packages+" "package-archives-host" "set-pair-to-alist")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "utility" '("*find-grep-dired--dir*" "*must-loading-files*" "clean-svn" "copy-buffer-string" "ensure-mkdir" "find" "load-" "show-symbol-at-point" "switch-default-dir" "trim-")))
...
;;;;;;  "codec.el" "eww-config.el" "fonts.el" "holiday-config.el"
;;;;;;  "ido-config.el" "mode-bars.el" "projectile-config.el" ...)
;;;;;;  (0 0 0 0))
